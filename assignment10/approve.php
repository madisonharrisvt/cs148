...
if (isset($_GET["q"])) {
    ...
    if ($key1 == $key1) {
        ...
        // notify admin
        $message = '<h2>You approved a user confirmation</h2>';
        ...
        $subject = "New PLH Camp Membership Confirmed: Approved";
        ...
        $bcc = "";
        $from = "NOT WRONG site <noreply@yoursite.com>";
        $subject = "Bobs PLH Registration Approved";
        $message = "<p>Thank you for taking the time to confirm your registration. Your confirmation has been approved.</p>";
